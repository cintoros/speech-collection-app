...
public class UserGroupService {
  ...
  public void postRecording(long groupId, RecordingDto recording,
                            MultipartFile file, DataElementDto otherDataElement,
  ...
  public ReturnWrapper postExcerpt(long groupId, TextDto textDto,
                                   DataElementDto otherDataElement,
    ...
    ReturnWrapper result = new ReturnWrapper(getDataElementDto(element.getId()),
                                             getExcerpt(text.getId()), null,
  ...
  public TextDto getExcerpt(Long groupId) {
    checkAllowed(groupId);
    return dslContext
        .select(TEXT.ID, TEXT.DIALECT_ID, TEXT.DATA_ELEMENT_ID,
