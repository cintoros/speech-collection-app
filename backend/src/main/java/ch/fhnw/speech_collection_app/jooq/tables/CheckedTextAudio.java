...
public class CheckedTextAudio extends TableImpl<CheckedTextAudioRecord> {
    ...
    private static final long serialVersionUID = -1831214460;
    ...
    public final TableField<CheckedTextAudioRecord, CheckedTextAudioLabel> LABEL = createField(DSL.name("label"), org.jooq.impl.SQLDataType.VARCHAR(14).defaultValue(org.jooq.impl.DSL.inline("NULL", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(ch.fhnw.speech_collection_app.jooq.enums.CheckedTextAudioLabel.class), this, "");
