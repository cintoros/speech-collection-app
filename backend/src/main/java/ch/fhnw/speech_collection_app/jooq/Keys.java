...
import ch.fhnw.speech_collection_app.jooq.tables.records.ExcerptRecord;
...
import ch.fhnw.speech_collection_app.jooq.tables.records.SpeakerRecord;
...
public class Keys {
    ...
    private static class ForeignKeys0 {
        public static final ForeignKey<CheckedRecordingRecord, RecordingRecord> CHECKED_RECORDING_IBFK_2 = Internal.createForeignKey(ch.fhnw.speech_collection_app.jooq.Keys.KEY_RECORDING_PRIMARY, CheckedRecording.CHECKED_RECORDING, "checked_recording_ibfk_2", CheckedRecording.CHECKED_RECORDING.RECORDING_ID);
        public static final ForeignKey<CheckedRecordingRecord, UserRecord> CHECKED_RECORDING_IBFK_1 = Internal.createForeignKey(ch.fhnw.speech_collection_app.jooq.Keys.KEY_USER_PRIMARY, CheckedRecording.CHECKED_RECORDING, "checked_recording_ibfk_1", CheckedRecording.CHECKED_RECORDING.USER_ID);
        public static final ForeignKey<CheckedTextAudioRecord, TextAudioRecord> CHECKED_TEXT_AUDIO_IBFK_2 = Internal.createForeignKey(ch.fhnw.speech_collection_app.jooq.Keys.KEY_TEXT_AUDIO_PRIMARY, CheckedTextAudio.CHECKED_TEXT_AUDIO, "checked_text_audio_ibfk_2", CheckedTextAudio.CHECKED_TEXT_AUDIO.TEXT_AUDIO_ID);
        public static final ForeignKey<CheckedTextAudioRecord, UserRecord> CHECKED_TEXT_AUDIO_IBFK_1 = Internal.createForeignKey(ch.fhnw.speech_collection_app.jooq.Keys.KEY_USER_PRIMARY, CheckedTextAudio.CHECKED_TEXT_AUDIO, "checked_text_audio_ibfk_1", CheckedTextAudio.CHECKED_TEXT_AUDIO.USER_ID);
        ...
        public static final ForeignKey<ExcerptRecord, OriginalTextRecord> EXCERPT_IBFK_1 = Internal.createForeignKey(ch.fhnw.speech_collection_app.jooq.Keys.KEY_ORIGINAL_TEXT_PRIMARY, Excerpt.EXCERPT, "excerpt_ibfk_1", Excerpt.EXCERPT.ORIGINAL_TEXT_ID);
        public static final ForeignKey<OriginalTextRecord, UserGroupRecord> ORIGINAL_TEXT_IBFK_1 = Internal.createForeignKey(ch.fhnw.speech_collection_app.jooq.Keys.KEY_USER_GROUP_PRIMARY, OriginalText.ORIGINAL_TEXT, "original_text_ibfk_1", OriginalText.ORIGINAL_TEXT.USER_GROUP_ID);
        public static final ForeignKey<OriginalTextRecord, DomainRecord> ORIGINAL_TEXT_IBFK_2 = Internal.createForeignKey(ch.fhnw.speech_collection_app.jooq.Keys.KEY_DOMAIN_PRIMARY, OriginalText.ORIGINAL_TEXT, "original_text_ibfk_2", OriginalText.ORIGINAL_TEXT.DOMAIN_ID);
        public static final ForeignKey<OriginalTextRecord, UserRecord> ORIGINAL_TEXT_IBFK_3 = Internal.createForeignKey(ch.fhnw.speech_collection_app.jooq.Keys.KEY_USER_PRIMARY, OriginalText.ORIGINAL_TEXT, "original_text_ibfk_3", OriginalText.ORIGINAL_TEXT.USER_ID);
        public static final ForeignKey<RecordingRecord, ExcerptRecord> RECORDING_IBFK_2 = Internal.createForeignKey(ch.fhnw.speech_collection_app.jooq.Keys.KEY_EXCERPT_PRIMARY, Recording.RECORDING, "recording_ibfk_2", Recording.RECORDING.EXCERPT_ID);
        public static final ForeignKey<RecordingRecord, UserRecord> RECORDING_IBFK_1 = Internal.createForeignKey(ch.fhnw.speech_collection_app.jooq.Keys.KEY_USER_PRIMARY, Recording.RECORDING, "recording_ibfk_1", Recording.RECORDING.USER_ID);
        public static final ForeignKey<TextAudioRecord, SpeakerRecord> TEXT_AUDIO_IBFK_1 = Internal.createForeignKey(ch.fhnw.speech_collection_app.jooq.Keys.KEY_SPEAKER_PRIMARY, TextAudio.TEXT_AUDIO, "text_audio_ibfk_1", TextAudio.TEXT_AUDIO.SPEAKER_ID);
        public static final ForeignKey<TextAudioRecord, SourceRecord> TEXT_AUDIO_IBFK_2 = Internal.createForeignKey(ch.fhnw.speech_collection_app.jooq.Keys.KEY_SOURCE_PRIMARY, TextAudio.TEXT_AUDIO, "text_audio_ibfk_2", TextAudio.TEXT_AUDIO.SOURCE_ID);
