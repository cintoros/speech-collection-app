...
public class Recording extends TableImpl<RecordingRecord> {
    ...
    private static final long serialVersionUID = -1862479271;
    ...
    public final TableField<RecordingRecord, RecordingLabel> LABEL = createField(DSL.name("label"), org.jooq.impl.SQLDataType.VARCHAR(14).defaultValue(org.jooq.impl.DSL.inline("NULL", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(ch.fhnw.speech_collection_app.jooq.enums.RecordingLabel.class), this, "");
    ...
    public final TableField<RecordingRecord, RecordingQuality> QUALITY = createField(DSL.name("quality"), org.jooq.impl.SQLDataType.VARCHAR(10).defaultValue(org.jooq.impl.DSL.inline("'INTEGRATED'", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(ch.fhnw.speech_collection_app.jooq.enums.RecordingQuality.class), this, "");

    public final TableField<RecordingRecord, RecordingNoiseLevel> NOISE_LEVEL = createField(DSL.name("noise_level"), org.jooq.impl.SQLDataType.VARCHAR(14).defaultValue(org.jooq.impl.DSL.inline("'NO_NOISE'", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(ch.fhnw.speech_collection_app.jooq.enums.RecordingNoiseLevel.class), this, "");
