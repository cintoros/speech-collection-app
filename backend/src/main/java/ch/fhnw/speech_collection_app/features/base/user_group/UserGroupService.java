...
public class UserGroupService {
    ...
    public long postExcerpt(long groupId, long idOfOtherDataElement, TextDto received_text,
            DataElementDto received_data_element) {
        checkAllowed(groupId);
        ...
        element.setUserGroupId(groupId);
        element.setUserId(customUserDetailsService.getLoggedInUserId());
        element.setIsPrivate(received_data_element.getIsPrivate());
        element.store();
    ...
    public ReturnWrapper getNext(long groupId, boolean textAllowed, boolean audioAllowed, boolean imageAllowed) {
        checkAllowed(groupId);
    ...
    public ImageDto getImageDto(Long groupId) {
        checkAllowed(groupId);
        return dslContext
                .select(IMAGE.DATA_ELEMENT_ID, DATA_ELEMENT.IS_PRIVATE).from(
