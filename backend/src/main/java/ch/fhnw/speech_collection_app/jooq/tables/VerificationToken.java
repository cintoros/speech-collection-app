...
public class VerificationToken extends TableImpl<VerificationTokenRecord> {
    ...
    public final TableField<VerificationTokenRecord, VerificationTokenTokenType> TOKEN_TYPE = createField(DSL.name("token_type"), org.jooq.impl.SQLDataType.VARCHAR(8).nullable(false).asEnumDataType(ch.fhnw.speech_collection_app.jooq.enums.VerificationTokenTokenType.class), this, "");
