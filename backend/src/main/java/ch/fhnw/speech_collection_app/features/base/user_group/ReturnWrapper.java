...
public class ReturnWrapper {
  ...
  public ReturnWrapper(DataElementDto dataElementDto, TextDto textDto,
                       AudioDto audioDto, ImageDto imageDto,
  ...
  public DataElementDto getDataElementDto() { return this.dataElementDto; }

  public void setDataElementDto(DataElementDto dataElementDto) {
    this.dataElementDto = dataElementDto;
  }

  public TextDto getTextDto() { return this.textDto; }

  public void setTextDto(TextDto textDto) { this.textDto = textDto; }

  public AudioDto getAudioDto() { return this.audioDto; }

  public void setAudioDto(AudioDto audioDto) { this.audioDto = audioDto; }

  public ImageDto getImageDto() { return this.imageDto; }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(dataElementDto, returnWrapper.dataElementDto) &&
        ...
        Objects.equals(audioDto, returnWrapper.audioDto) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dataElementDto, textDto, audioDto, imageDto,
                        elementType);
  }
  ...
  public String toString() {
    return "{"
        + " dataElementDto='" + getDataElementDto() + "'"
        + ", textDto='" + getTextDto() + "'"
  ...
  public enum ElementType { TEXT, AUDIO, IMAGE }
}
