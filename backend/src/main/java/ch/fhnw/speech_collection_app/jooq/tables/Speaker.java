...
public class Speaker extends TableImpl<SpeakerRecord> {
    ...
    private static final long serialVersionUID = 339705945;
    ...
    public final TableField<SpeakerRecord, SpeakerSex> SEX = createField(DSL.name("sex"), org.jooq.impl.SQLDataType.VARCHAR(4).defaultValue(org.jooq.impl.DSL.inline("'NONE'", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(ch.fhnw.speech_collection_app.jooq.enums.SpeakerSex.class), this, "");
